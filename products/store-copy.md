# Store copy — paste into the product editor

## The CMO Seat Starter Kit
...
```
Free. The cost table, the kickoff script, the three numbers, and the benchmark sheet, plus a Claude skill that runs the kickoff for you.
```

**Description (markdown)**

````markdown
## Sit in the CMO seat for ten minutes before you spend a dollar on ads
...
```
The 20-page 22nd Century Marketing manual, the cmo-seat Claude skill, the worksheets, and the prompt pack. Direct response ads for local businesses, fulfilled with ToMarket.io.
```

**Description (markdown)**

````markdown
## An ad department is seven seats and about a million dollars a year
