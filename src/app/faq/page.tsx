...
export const metadata: Metadata = {
  title: "FAQ",
  description: "Fees, payouts, refunds, file limits, what you can sell, and how delivery works on visitmy.shop.",
  alternates: { canonical: "/faq" },
};

const FAQ: [string, string][] = [
  ["Is visitmy.shop free?", "Yes. During early access there is no monthly fee and no platform fee on sales. On paid products Stripe charges its standard card processing fee, which goes to Stripe."],
  ...
  ["What is the Instagram DM keyword?", "Give a product a keyword. When someone comments or messages that word on Instagram, we reply with the product link automatically, using a message you write."],
  ["Do you offer courses, memberships, or bookings?", "Not yet. Courses, bookings, and communities are coming. Today the focus is the bio-link store for digital products, done better than anyone."],
];
