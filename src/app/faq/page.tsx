...
const FAQ: [string, string][] = [
  ...
  ["When should I move from Basic to Pro?", "Basic is cheaper until you sell about $800 a month. Above that, Pro's 0% fee saves you more than the $40 difference in price. Pro also has the full design editor, booking calls, Instagram auto-replies, pricing tiers and pay what you want, up to five order bumps, discount codes, custom checkout questions, your own Meta, Google, and TikTok pixels, branding removal, and team access."],
