...
/**
 * Branded email shell. Cream page, white card, the wordmark as a hosted PNG
...
export const emailStyles = {
  body: { backgroundColor: cream, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif", margin: 0, padding: "40px 12px" },
  ...
  fileRow: { padding: "14px 16px", border: `1px solid ${border}`, borderRadius: 12, marginBottom: 8, backgroundColor: cream },
